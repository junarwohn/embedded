...
int saveenv(void)
{
	...
	// By JhKim : INF_REG3_REG Value Doesn't Matched of S5PC100 Processor. (Nand Boot Mode)
//	if (INF_REG3_REG == 2 || INF_REG3_REG == 3)
	if (INF_REG3_REG == 3)
		saveenv_nand();
	// By JhKim : INF_REG3_REG Value Doesn't Matched of S5PC100 Processor. (NOR Boot Mode)
	else if (INF_REG3_REG == 2 || INF_REG3_REG == 4 || INF_REG3_REG == 5 
			|| INF_REG3_REG == 6 || INF_REG3_REG == 0xe4200000)
		saveenv_nand_adv();
...
{
#if !defined(CONFIG_SMDK6440)
	// By JhKim : INF_REG3_REG Value Doesn't Matched of S5PC100 Processor.
	if ((INF_REG3_REG >= 2 && INF_REG3_REG <= 6) || (INF_REG3_REG == 0xe4200000))
