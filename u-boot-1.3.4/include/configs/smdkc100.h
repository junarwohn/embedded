 ...
 */
#define CONFIG_SERIAL2          1	/* we use SERIAL 2 on SMDK6400 */
...
#define CONFIG_NFS_BOOT		

#ifdef CONFIG_NFS_BOOT
//#define CONFIG_BOOTARGS    	"mem=128M root=/dev/nfs rw nfsroot=192.168.1.15:/nfsroot/s5pc1xx-rootfs ip=192.168.1.100:192.168.1.15:192.168.1.1:255.255.255.0::eth0:off console=ttySAC1,115200n81 ethaddr=08:00:3e:26:0a:5b"
#define CONFIG_BOOTARGS    	"mem=256M root=/dev/nfs rw nfsroot=192.168.11.104:/nfsroot/s5pc1xx-rootfs ip=192.168.11.102:192.168.11.104:192.168.11.1:255.255.255.0::eth0:off console=ttySAC1,115200n81 ethaddr=08:00:3e:26:0a:5b"
#define CONFIG_BOOTCOMMAND	"tftp 0xc0008000 zImage-S5PC100\;bootm 0xc0008000"
#elif defined CONFIG_NAND_BOOT
#define CONFIG_BOOTARGS         ""
#define CONFIG_BOOTCOMMAND      ""
#endif /* CONFIG_NFS_BOOT */
...
#define CONFIG_IPADDR		192.168.11.102
#define CONFIG_SERVERIP		192.168.11.104
...
#define CFG_PROMPT		"2022169108 # "	/* Monitor Command Prompt	*/
...
#define CONFIG_IDENT_STRING	" for SL2_C100"
...
#else
#define NAND_DISABLE_CE()       (NFCONT_REG |= (2 << 1))
#define NAND_ENABLE_CE()        (NFCONT_REG &= ~(2 << 1))
#define NF_TRANSRnB()           do { while(!(NFSTAT_REG & (1 << 0))); } while(0)
#endif
...
//#define CFG_STACK_IRAM
//#define CFG_STACK_RELOCATE
