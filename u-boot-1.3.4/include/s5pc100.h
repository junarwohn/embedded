...
#define CONFIG_S5PC100			1
#endif

#define S5PC1XX_UART_CHANNELS		3
#define S5PC1XX_SPI_CHANNELS		2
...
#define HPLL_LOCK_OFFSET		0x0c
#define APLL_CON_OFFSET			0x100
#define MPLL_CON_OFFSET			0x104
#define EPLL_CON_OFFSET			0x108
#define HPLL_CON_OFFSET			0x10c
...
#define CLK_OUT_OFFSET			0x400
#define CLK_GATE_D0_0_OFFSET		0x500
#define CLK_GATE_D0_1_OFFSET		0x504
#define CLK_GATE_D0_2_OFFSET		0x508
#define CLK_GATE_D1_0_OFFSET		0x520
#define CLK_GATE_D1_1_OFFSET		0x524
#define CLK_GATE_D1_2_OFFSET		0x528
#define CLK_GATE_D1_3_OFFSET		0x52c
#define CLK_GATE_D1_4_OFFSET		0x530
#define CLK_GATE_D1_5_OFFSET		0x534
#define CLK_GATE_D2_0_OFFSET		0x540
#define CLK_GATE_SCLK_0_OFFSET		0x560
#define CLK_GATE_SCLK_1_OFFSET		0x564

#define AHB_CON0_OFFSET			0x100
#define AHB_CON1_OFFSET			0x104
#define AHB_CON2_OFFSET			0x108
#define SELECT_DMA_OFFSET		0x110
#define SW_RST_OFFSET			0x100000
...
#define NOR_CFG_OFFSET			0x8010
#define STOP_CFG_OFFSET			0x814
#define SLEEP_CFG_OFFSET		0x8018
...
#define OTHERS_OFFSET			0x8200
#define RST_STAT_OFFSET			0x8300
#define WAKEUP_STAT_OFFSET		0x8304
#define BLK_PWR_STAT_OFFSET		0x8308
...
#define CLK_GATE_D0_0_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D0_0_OFFSET)
#define CLK_GATE_D0_1_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D0_1_OFFSET)
#define CLK_GATE_D0_2_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D0_2_OFFSET)
#define CLK_GATE_D1_0_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_0_OFFSET)
#define CLK_GATE_D1_1_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_1_OFFSET)
#define CLK_GATE_D1_2_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_2_OFFSET)
#define CLK_GATE_D1_3_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_3_OFFSET)
#define CLK_GATE_D1_4_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_4_OFFSET)
#define CLK_GATE_D1_5_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D1_5_OFFSET)
#define CLK_GATE_D2_0_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_D2_0_OFFSET)
#define CLK_GATE_SCLK_0_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_SCLK_0_OFFSET)
#define CLK_GATE_SCLK_1_REG		__REG(ELFIN_CLOCK_POWER_BASE+CLK_GATE_SCLK_1_OFFSET)
...
#define INF_REG_BASE			0xE0108400
...
#define GPA0DRV_OFFSET			0x00c
#define GPA0CONSLP_OFFSET		0x010
#define GPA0PUDSLP_OFFSET		0x014

/* GPA1 */
#define GPA1CON_OFFSET			0x020
#define GPA1DAT_OFFSET			0x024
#define GPA1PUD_OFFSET			0x028
#define GPA1DRV_OFFSET			0x02c
#define GPA1CONSLP_OFFSET		0x030
#define GPA1PUDSLP_OFFSET		0x034

/* GPB */
#define GPBCON_OFFSET 			0x040
#define GPBDAT_OFFSET 			0x044
#define GPBPUD_OFFSET 			0x048
#define GPBDRV_OFFSET 			0x04C
#define GPBCONPDN_OFFSET 		0x050
#define GPBPUDPDN_OFFSET 		0x054

/* GPC */
#define GPCCON_OFFSET 			0x060
#define GPCDAT_OFFSET 			0x064
#define GPCPUD_OFFSET 			0x068
#define GPCDRV_OFFSET 			0x06C
#define GPCCONPDN_OFFSET 		0x070
#define GPCPUDPDN_OFFSET 		0x074

/* GPD */
#define GPDCON_OFFSET 			0x080
#define GPDDAT_OFFSET 			0x084
#define GPDPUD_OFFSET 			0x088
#define GPDDRV_OFFSET 			0x08C
#define GPDCONPDN_OFFSET 		0x090
#define GPDPUDPDN_OFFSET 		0x094

/* GPE0 */
#define GPE0CON_OFFSET 			0x0A0
#define GPE0DAT_OFFSET 			0x0A4
#define GPE0PUD_OFFSET 			0x0A8
#define GPE0DRV_OFFSET 			0x0AC
#define GPE0CONPDN_OFFSET 		0x0B0
#define GPE0PUDPDN_OFFSET 		0x0B4

/* GPE1 */
#define GPE1CON_OFFSET 			0x0C0
#define GPE1DAT_OFFSET 			0x0C4
#define GPE1PUD_OFFSET 			0x0C8
#define GPE1DRV_OFFSET 			0x0CC
#define GPE1CONPDN_OFFSET 		0x0D0
#define GPE1PUDPDN_OFFSET 		0x0D4

/* GPF0 */
#define GPF0CON_OFFSET 			0x0E0
#define GPF0DAT_OFFSET 			0x0E4
#define GPF0PUD_OFFSET 			0x0E8
#define GPF0DRV_OFFSET 			0x0EC
#define GPF0CONPDN_OFFSET 		0x0F0
#define GPF0PUDPDN_OFFSET 		0x0F4

/* GPF1 */
#define GPF1CON_OFFSET 			0x100
#define GPF1DAT_OFFSET 			0x104
#define GPF1PUD_OFFSET 			0x108
#define GPF1DRV_OFFSET 			0x10C
#define GPF1CONPDN_OFFSET 		0x110
#define GPF1PUDPDN_OFFSET 		0x114

/* GPF2 */
#define GPF2CON_OFFSET 			0x120
#define GPF2DAT_OFFSET 			0x124
#define GPF2PUD_OFFSET 			0x128
#define GPF2DRV_OFFSET 			0x12C
#define GPF2CONPDN_OFFSET 		0x130
#define GPF2PUDPDN_OFFSET 		0x134

/* GPF3 */
#define GPF3CON_OFFSET 			0x140
#define GPF3DAT_OFFSET 			0x144
#define GPF3PUD_OFFSET 			0x148
#define GPF3DRV_OFFSET 			0x14C
#define GPF3CONPDN_OFFSET 		0x150
#define GPF3PUDPDN_OFFSET 		0x154

/* GPG0 */
#define GPG0CON_OFFSET 			0x160
#define GPG0DAT_OFFSET 			0x164
#define GPG0PUD_OFFSET 			0x168
#define GPG0DRV_OFFSET 			0x16C
#define GPG0CONPDN_OFFSET 		0x170
#define GPG0PUDPDN_OFFSET 		0x174

/* GPG1 */
#define GPG1CON_OFFSET 			0x180
#define GPG1DAT_OFFSET 			0x184
#define GPG1PUD_OFFSET 			0x188
#define GPG1DRV_OFFSET 			0x18C
#define GPG1CONPDN_OFFSET		0x190
#define GPG1PUDPDN_OFFSET 		0x194

/* GPG2 */
#define GPG2CON_OFFSET 			0x1A0
#define GPG2DAT_OFFSET 			0x1A4
#define GPG2PUD_OFFSET 			0x1A8
#define GPG2DRV_OFFSET 			0x1AC
#define GPG2CONPDN_OFFSET 		0x1B0
#define GPG2PUDPDN_OFFSET 		0x1B4

/* GPG3 */
#define GPG3CON_OFFSET 			0x1C0
#define GPG3DAT_OFFSET 			0x1C4
#define GPG3PUD_OFFSET 			0x1C8
#define GPG3DRV_OFFSET 			0x1CC
#define GPG3CONPDN_OFFSET 		0x1D0
#define GPG3PUDPDN_OFFSET 		0x1D4
...
/* GPI */
#define GPICON_OFFSET 			0x1E0
#define GPIDAT_OFFSET 			0x1E4
#define GPIPUD_OFFSET 			0x1E8
#define GPIDRV_OFFSET 			0x1EC
#define GPICONPDN_OFFSET 		0xEF0
#define GPIPUDPDN_OFFSET 		0xEF4

/* GPJ0 */
#define GPJ0CON_OFFSET 			0x200
#define GPJ0DAT_OFFSET 			0x204
#define GPJ0PUD_OFFSET 			0x208
#define GPJ0DRV_OFFSET 			0x20C
...
#define GPJ4DRV_OFFSET 			0x28C
#define GPJ4CONPDN_OFFSET 		0x290
#define GPJ4PUDPDN_OFFSET 		0x294

/* GPK0 */
#define GPK0CON_OFFSET 			0x2A0
#define GPK0DAT_OFFSET 			0x2A4
#define GPK0PUD_OFFSET 			0x2A8
#define GPK0DRV_OFFSET 			0x2AC
#define GPK0CONPDN_OFFSET 		0x2B0
#define GPK0PUDPDN_OFFSET 		0x2B4

/* GPK1 */
#define GPK1CON_OFFSET 			0x2C0
#define GPK1DAT_OFFSET 			0x2C4
#define GPK1PUD_OFFSET 			0x2C8
#define GPK1DRV_OFFSET 			0x2CC
#define GPK1CONPDN_OFFSET 		0x2D0
#define GPK1PUDPDN_OFFSET 		0x2D4

/* GPK2 */
#define GPK2CON_OFFSET 			0x2E0
#define GPK2DAT_OFFSET 			0x2E4
#define GPK2PUD_OFFSET 			0x2E8
#define GPK2DRV_OFFSET 			0x2EC
#define GPK2CONPDN_OFFSET 		0x2F0
#define GPK2PUDPDN_OFFSET 		0x2F4

/* GPK3 */
#define GPK3CON_OFFSET 			0x300
#define GPK3DAT_OFFSET 			0x304
#define GPK3PUD_OFFSET 			0x308
#define GPK3DRV_OFFSET 			0x30C
#define GPK3CONPDN_OFFSET 		0x310
#define GPK3PUDPDN_OFFSET 		0x314

#define GPA0CON_REG			__REG(ELFIN_GPIO_BASE+GPA0CON_OFFSET)
#define GPA0DAT_REG			__REG(ELFIN_GPIO_BASE+GPA0DAT_OFFSET)
#define GPA0PUD_REG			__REG(ELFIN_GPIO_BASE+GPA0PUD_OFFSET)
#define GPA0DRV_REG			__REG(ELFIN_GPIO_BASE+GPA0DRV_OFFSET)
#define GPA0CONSLP_REG			__REG(ELFIN_GPIO_BASE+GPA0CONSLP_OFFSET)
#define GPA0PUDSLP_REG			__REG(ELFIN_GPIO_BASE+GPA0PUDSLP_OFFSET)
#define GPA1CON_REG			__REG(ELFIN_GPIO_BASE+GPA1CON_OFFSET)
#define GPA1DAT_REG			__REG(ELFIN_GPIO_BASE+GPA1DAT_OFFSET)
#define GPA1PUD_REG			__REG(ELFIN_GPIO_BASE+GPA1PUD_OFFSET)
#define GPA1DRV_REG			__REG(ELFIN_GPIO_BASE+GPA1DRV_OFFSET)
#define GPA1CONSLP_REG			__REG(ELFIN_GPIO_BASE+GPA1CONSLP_OFFSET)
#define GPA1PUDSLP_REG			__REG(ELFIN_GPIO_BASE+GPA1PUDSLP_OFFSET)
...
#define GPBDRV_REG			__REG(ELFIN_GPIO_BASE+GPBDRV_OFFSET)
#define GPBCONPDN_REG			__REG(ELFIN_GPIO_BASE+GPBCONPDN_OFFSET)
#define GPBPUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPBPUDPDN_OFFSET)
...
#define GPCDRV_REG			__REG(ELFIN_GPIO_BASE+GPCDRV_OFFSET)
#define GPCCONPDN_REG			__REG(ELFIN_GPIO_BASE+GPCCONPDN_OFFSET)
#define GPCPUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPCPUDPDN_OFFSET)
...
#define GPDDRV_REG			__REG(ELFIN_GPIO_BASE+GPDDRV_OFFSET)
#define GPDCONPDN_REG			__REG(ELFIN_GPIO_BASE+GPDCONPDN_OFFSET)
#define GPDPUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPDPUDPDN_OFFSET)
#define GPE0CON_REG			__REG(ELFIN_GPIO_BASE+GPE0CON_OFFSET)
#define GPE0DAT_REG			__REG(ELFIN_GPIO_BASE+GPE0DAT_OFFSET)
#define GPE0PUD_REG			__REG(ELFIN_GPIO_BASE+GPE0PUD_OFFSET)
#define GPE0DRV_REG			__REG(ELFIN_GPIO_BASE+GPE0DRV_OFFSET)
#define GPE0CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPE0CONPDN_OFFSET)
#define GPE0PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPE0PUDPDN_OFFSET)
#define GPE1CON_REG			__REG(ELFIN_GPIO_BASE+GPE1CON_OFFSET)
#define GPE1DAT_REG			__REG(ELFIN_GPIO_BASE+GPE1DAT_OFFSET)
#define GPE1PUD_REG			__REG(ELFIN_GPIO_BASE+GPE1PUD_OFFSET)
#define GPE1DRV_REG			__REG(ELFIN_GPIO_BASE+GPE1DRV_OFFSET)
#define GPE1CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPE1CONPDN_OFFSET)
#define GPE1PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPE1PUDPDN_OFFSET)
#define GPF0CON_REG			__REG(ELFIN_GPIO_BASE+GPF0CON_OFFSET)
#define GPF0DAT_REG			__REG(ELFIN_GPIO_BASE+GPF0DAT_OFFSET)
#define GPF0PUD_REG			__REG(ELFIN_GPIO_BASE+GPF0PUD_OFFSET)
#define GPF0DRV_REG			__REG(ELFIN_GPIO_BASE+GPF0DRV_OFFSET)
#define GPF0CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPF0CONPDN_OFFSET)
#define GPF0PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPF0PUDPDN_OFFSET)
#define GPF1CON_REG			__REG(ELFIN_GPIO_BASE+GPF1CON_OFFSET)
#define GPF1DAT_REG			__REG(ELFIN_GPIO_BASE+GPF1DAT_OFFSET)
#define GPF1PUD_REG			__REG(ELFIN_GPIO_BASE+GPF1PUD_OFFSET)
#define GPF1DRV_REG			__REG(ELFIN_GPIO_BASE+GPF1DRV_OFFSET)
#define GPF1CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPF1CONPDN_OFFSET)
#define GPF1PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPF1PUDPDN_OFFSET)
#define GPF2CON_REG			__REG(ELFIN_GPIO_BASE+GPF2CON_OFFSET)
#define GPF2DAT_REG			__REG(ELFIN_GPIO_BASE+GPF2DAT_OFFSET)
#define GPF2PUD_REG			__REG(ELFIN_GPIO_BASE+GPF2PUD_OFFSET)
#define GPF2DRV_REG			__REG(ELFIN_GPIO_BASE+GPF2DRV_OFFSET)
#define GPF2CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPF2CONPDN_OFFSET)
#define GPF2PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPF2PUDPDN_OFFSET)
#define GPF3CON_REG			__REG(ELFIN_GPIO_BASE+GPF3CON_OFFSET)
#define GPF3DAT_REG			__REG(ELFIN_GPIO_BASE+GPF3DAT_OFFSET)
#define GPF3PUD_REG			__REG(ELFIN_GPIO_BASE+GPF3PUD_OFFSET)
#define GPF3DRV_REG			__REG(ELFIN_GPIO_BASE+GPF3DRV_OFFSET)
#define GPF3CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPF3CONPDN_OFFSET)
#define GPF3PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPF3PUDPDN_OFFSET)
#define GPG0CON_REG			__REG(ELFIN_GPIO_BASE+GPG0CON_OFFSET)
#define GPG0DAT_REG			__REG(ELFIN_GPIO_BASE+GPG0DAT_OFFSET)
#define GPG0PUD_REG			__REG(ELFIN_GPIO_BASE+GPG0PUD_OFFSET)
#define GPG0DRV_REG			__REG(ELFIN_GPIO_BASE+GPG0DRV_OFFSET)
#define GPG0CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPG0CONPDN_OFFSET)
#define GPG0PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPG0PUDPDN_OFFSET)
#define GPG1CON_REG			__REG(ELFIN_GPIO_BASE+GPG1CON_OFFSET)
#define GPG1DAT_REG			__REG(ELFIN_GPIO_BASE+GPG1DAT_OFFSET)
#define GPG1PUD_REG			__REG(ELFIN_GPIO_BASE+GPG1PUD_OFFSET)
#define GPG1DRV_REG			__REG(ELFIN_GPIO_BASE+GPG1DRV_OFFSET)
#define GPG1CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPG1CONPDN_OFFSET)
#define GPG1PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPG1PUDPDN_OFFSET)
#define GPG2CON_REG			__REG(ELFIN_GPIO_BASE+GPG2CON_OFFSET)
#define GPG2DAT_REG			__REG(ELFIN_GPIO_BASE+GPG2DAT_OFFSET)
#define GPG2PUD_REG			__REG(ELFIN_GPIO_BASE+GPG2PUD_OFFSET)
#define GPG2DRV_REG			__REG(ELFIN_GPIO_BASE+GPG2DRV_OFFSET)
#define GPG2CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPG2CONPDN_OFFSET)
#define GPG2PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPG2PUDPDN_OFFSET)
#define GPG3CON_REG			__REG(ELFIN_GPIO_BASE+GPG3CON_OFFSET)
#define GPG3DAT_REG			__REG(ELFIN_GPIO_BASE+GPG3DAT_OFFSET)
#define GPG3PUD_REG			__REG(ELFIN_GPIO_BASE+GPG3PUD_OFFSET)
#define GPG3DRV_REG			__REG(ELFIN_GPIO_BASE+GPG3DRV_OFFSET)
#define GPG3CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPG3CONPDN_OFFSET)
#define GPG3PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPG3PUDPDN_OFFSET)
#define GPH0CON_REG			__REG(ELFIN_GPIO_BASE+GPH0CON_OFFSET)
#define GPH0DAT_REG			__REG(ELFIN_GPIO_BASE+GPH0DAT_OFFSET)
#define GPH0PUD_REG			__REG(ELFIN_GPIO_BASE+GPH0PUD_OFFSET)
#define GPH0DRV_REG			__REG(ELFIN_GPIO_BASE+GPH0DRV_OFFSET)
...
#define GPIDRV_REG			__REG(ELFIN_GPIO_BASE+GPIDRV_OFFSET)
#define GPICONPDN_REG			__REG(ELFIN_GPIO_BASE+GPICONPDN_OFFSET)
#define GPIPUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPIPUDPDN_OFFSET)
#define GPJ0CON_REG			__REG(ELFIN_GPIO_BASE+GPJ0CON_OFFSET)
#define GPJ0DAT_REG			__REG(ELFIN_GPIO_BASE+GPJ0DAT_OFFSET)
#define GPJ0PUD_REG			__REG(ELFIN_GPIO_BASE+GPJ0PUD_OFFSET)
#define GPJ0DRV_REG			__REG(ELFIN_GPIO_BASE+GPJ0DRV_OFFSET)
#define GPJ0CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ0CONPDN_OFFSET)
#define GPJ0PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ0PUDPDN_OFFSET)
#define GPJ1CON_REG			__REG(ELFIN_GPIO_BASE+GPJ1CON_OFFSET)
#define GPJ1DAT_REG			__REG(ELFIN_GPIO_BASE+GPJ1DAT_OFFSET)
#define GPJ1PUD_REG			__REG(ELFIN_GPIO_BASE+GPJ1PUD_OFFSET)
#define GPJ1DRV_REG			__REG(ELFIN_GPIO_BASE+GPJ1DRV_OFFSET)
#define GPJ1CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ1CONPDN_OFFSET)
#define GPJ1PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ1PUDPDN_OFFSET)
#define GPJ2CON_REG			__REG(ELFIN_GPIO_BASE+GPJ2CON_OFFSET)
#define GPJ2DAT_REG			__REG(ELFIN_GPIO_BASE+GPJ2DAT_OFFSET)
#define GPJ2PUD_REG			__REG(ELFIN_GPIO_BASE+GPJ2PUD_OFFSET)
#define GPJ2DRV_REG			__REG(ELFIN_GPIO_BASE+GPJ2DRV_OFFSET)
#define GPJ2CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ2CONPDN_OFFSET)
#define GPJ2PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ2PUDPDN_OFFSET)
#define GPJ3CON_REG			__REG(ELFIN_GPIO_BASE+GPJ3CON_OFFSET)
#define GPJ3DAT_REG			__REG(ELFIN_GPIO_BASE+GPJ3DAT_OFFSET)
#define GPJ3PUD_REG			__REG(ELFIN_GPIO_BASE+GPJ3PUD_OFFSET)
#define GPJ3DRV_REG			__REG(ELFIN_GPIO_BASE+GPJ3DRV_OFFSET)
#define GPJ3CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ3CONPDN_OFFSET)
#define GPJ3PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ3PUDPDN_OFFSET)
#define GPJ4CON_REG			__REG(ELFIN_GPIO_BASE+GPJ4CON_OFFSET)
#define GPJ4DAT_REG			__REG(ELFIN_GPIO_BASE+GPJ4DAT_OFFSET)
#define GPJ4PUD_REG			__REG(ELFIN_GPIO_BASE+GPJ4PUD_OFFSET)
#define GPJ4DRV_REG			__REG(ELFIN_GPIO_BASE+GPJ4DRV_OFFSET)
#define GPJ4CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ4CONPDN_OFFSET)
#define GPJ4PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPJ4PUDPDN_OFFSET)
#define GPK0CON_REG			__REG(ELFIN_GPIO_BASE+GPK0CON_OFFSET)
#define GPK0DAT_REG			__REG(ELFIN_GPIO_BASE+GPK0DAT_OFFSET)
#define GPK0PUD_REG			__REG(ELFIN_GPIO_BASE+GPK0PUD_OFFSET)
#define GPK0DRV_REG			__REG(ELFIN_GPIO_BASE+GPK0DRV_OFFSET)
#define GPK0CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPK0CONPDN_OFFSET)
#define GPK0PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPK0PUDPDN_OFFSET)
#define GPK1CON_REG			__REG(ELFIN_GPIO_BASE+GPK1CON_OFFSET)
#define GPK1DAT_REG			__REG(ELFIN_GPIO_BASE+GPK1DAT_OFFSET)
#define GPK1PUD_REG			__REG(ELFIN_GPIO_BASE+GPK1PUD_OFFSET)
#define GPK1DRV_REG			__REG(ELFIN_GPIO_BASE+GPK1DRV_OFFSET)
#define GPK1CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPK1CONPDN_OFFSET)
#define GPK1PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPK1PUDPDN_OFFSET)
#define GPK2CON_REG			__REG(ELFIN_GPIO_BASE+GPK2CON_OFFSET)
#define GPK2DAT_REG			__REG(ELFIN_GPIO_BASE+GPK2DAT_OFFSET)
#define GPK2PUD_REG			__REG(ELFIN_GPIO_BASE+GPK2PUD_OFFSET)
#define GPK2DRV_REG			__REG(ELFIN_GPIO_BASE+GPK2DRV_OFFSET)
#define GPK2CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPK2CONPDN_OFFSET)
#define GPK2PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPK2PUDPDN_OFFSET)
#define GPK3CON_REG			__REG(ELFIN_GPIO_BASE+GPK3CON_OFFSET)
#define GPK3DAT_REG			__REG(ELFIN_GPIO_BASE+GPK3DAT_OFFSET)
#define GPK3PUD_REG			__REG(ELFIN_GPIO_BASE+GPK3PUD_OFFSET)
#define GPK3DRV_REG			__REG(ELFIN_GPIO_BASE+GPK3DRV_OFFSET)
#define GPK3CONPDN_REG			__REG(ELFIN_GPIO_BASE+GPK3CONPDN_OFFSET)
#define GPK3PUDPDN_REG			__REG(ELFIN_GPIO_BASE+GPK3PUDPDN_OFFSET)
...
#define GPA0DRV				(ELFIN_GPIO_BASE+GPA0DRV_OFFSET)
#define GPA0CONSLP			(ELFIN_GPIO_BASE+GPA0CONSLP_OFFSET)
#define GPA0PUDSLP			(ELFIN_GPIO_BASE+GPA0PUDSLP_OFFSET)
...
#define GPA1DRV				(ELFIN_GPIO_BASE+GPA1DRV_OFFSET)
#define GPA1CONSLP			(ELFIN_GPIO_BASE+GPA1CONSLP_OFFSET)
#define GPA1PUDSLP			(ELFIN_GPIO_BASE+GPA1PUDSLP_OFFSET)
...
#define GPBDRV				(ELFIN_GPIO_BASE+GPBDRV_OFFSET)
...
#define GPCDRV				(ELFIN_GPIO_BASE+GPCDRV_OFFSET)
#define GPCCONPDN			(ELFIN_GPIO_BASE+GPCCONPDN_OFFSET)
#define GPCPUDPDN			(ELFIN_GPIO_BASE+GPCPUDPDN_OFFSET)
...
#define GPDDRV				(ELFIN_GPIO_BASE+GPDDRV_OFFSET)
#define GPDCONPDN			(ELFIN_GPIO_BASE+GPDCONPDN_OFFSET)
#define GPDPUDPDN			(ELFIN_GPIO_BASE+GPDPUDPDN_OFFSET)
...
#define GPE0DRV				(ELFIN_GPIO_BASE+GPE0DRV_OFFSET)
...
#define GPE1DRV				(ELFIN_GPIO_BASE+GPE1DRV_OFFSET)
...
#define GPF0DRV				(ELFIN_GPIO_BASE+GPF0DRV_OFFSET)
...
#define GPF1DRV				(ELFIN_GPIO_BASE+GPF1DRV_OFFSET)
...
#define GPF2DRV				(ELFIN_GPIO_BASE+GPF2DRV_OFFSET)
...
#define GPF3DRV				(ELFIN_GPIO_BASE+GPF3DRV_OFFSET)
...
#define GPG0DRV				(ELFIN_GPIO_BASE+GPG0DRV_OFFSET)
...
#define GPG1DRV				(ELFIN_GPIO_BASE+GPG1DRV_OFFSET)
...
#define GPG2DRV				(ELFIN_GPIO_BASE+GPG2DRV_OFFSET)
...
#define GPG3DRV				(ELFIN_GPIO_BASE+GPG3DRV_OFFSET)
...
#define GPIDRV				(ELFIN_GPIO_BASE+GPIDRV_OFFSET)
#define GPICONPDN			(ELFIN_GPIO_BASE+GPICONPDN_OFFSET)
...
#define GPJ0DRV				(ELFIN_GPIO_BASE+GPJ0DRV_OFFSET)
...
#define GPJ1DRV				(ELFIN_GPIO_BASE+GPJ1DRV_OFFSET)
...
#define GPJ2DRV				(ELFIN_GPIO_BASE+GPJ2DRV_OFFSET)
...
#define GPJ3DRV				(ELFIN_GPIO_BASE+GPJ3DRV_OFFSET)
...
#define GPJ4DRV				(ELFIN_GPIO_BASE+GPJ4DRV_OFFSET)
#define GPJ4CONPDN			(ELFIN_GPIO_BASE+GPJ4CONPDN_OFFSET)
#define GPJ4PUDPDN			(ELFIN_GPIO_BASE+GPJ4PUDPDN_OFFSET)
#define GPK0CON				(ELFIN_GPIO_BASE+GPK0CON_OFFSET)
#define GPK0DAT				(ELFIN_GPIO_BASE+GPK0DAT_OFFSET)
#define GPK0PUD				(ELFIN_GPIO_BASE+GPK0PUD_OFFSET)
#define GPK0DRV				(ELFIN_GPIO_BASE+GPK0DRV_OFFSET)
#define GPK0CONPDN			(ELFIN_GPIO_BASE+GPK0CONPDN_OFFSET)
#define GPK0PUDPDN			(ELFIN_GPIO_BASE+GPK0PUDPDN_OFFSET)
#define GPK1CON				(ELFIN_GPIO_BASE+GPK1CON_OFFSET)
#define GPK1DAT				(ELFIN_GPIO_BASE+GPK1DAT_OFFSET)
#define GPK1PUD				(ELFIN_GPIO_BASE+GPK1PUD_OFFSET)
#define GPK1DRV				(ELFIN_GPIO_BASE+GPK1DRV_OFFSET)
#define GPK1CONPDN			(ELFIN_GPIO_BASE+GPK1CONPDN_OFFSET)
#define GPK1PUDPDN			(ELFIN_GPIO_BASE+GPK1PUDPDN_OFFSET)
#define GPK2CON				(ELFIN_GPIO_BASE+GPK2CON_OFFSET)
#define GPK2DAT				(ELFIN_GPIO_BASE+GPK2DAT_OFFSET)
#define GPK2PUD				(ELFIN_GPIO_BASE+GPK2PUD_OFFSET)
#define GPK2DRV				(ELFIN_GPIO_BASE+GPK2DRV_OFFSET)
#define GPK2CONPDN			(ELFIN_GPIO_BASE+GPK2CONPDN_OFFSET)
#define GPK2PUDPDN			(ELFIN_GPIO_BASE+GPK2PUDPDN_OFFSET)
#define GPK3CON				(ELFIN_GPIO_BASE+GPK3CON_OFFSET)
#define GPK3DAT				(ELFIN_GPIO_BASE+GPK3DAT_OFFSET)
#define GPK3PUD				(ELFIN_GPIO_BASE+GPK3PUD_OFFSET)
#define GPK3DRV				(ELFIN_GPIO_BASE+GPK3DRV_OFFSET)
#define GPK3CONPDN			(ELFIN_GPIO_BASE+GPK3CONPDN_OFFSET)
#define GPK3PUDPDN			(ELFIN_GPIO_BASE+GPK3PUDPDN_OFFSET)
 ...
 */
#define ELFIN_NAND_BASE			0xE7200000
 ...
 * OneNAND Controller
 *************************************************************/
#define ELFIN_ONENAND_BASE		0xE7100000
...
#define ELFIN_TZIC0_BASE_ADDR		(0xE5000000)
#define ELFIN_TZIC1_BASE_ADDR		(0xE5100000)
#define ELFIN_TZIC2_BASE_ADDR		(0xE5200000)
 ...
 * RTC Controller
 */
#define ELFIN_RTC_BASE			0xEA300000

#define INTP_OFFSET			(0x30)
#define RTCCON_OFFSET			(0x40)
#define TICNT_OFFSET			(0x44)
...
#define CUTICCNT_OFFSET			(0x90)

#define RTC_INTP_REG			__REG(ELFIN_RTC_BASE+INTP_OFFSET)
#define RTC_RTCCON_REG			__REG(ELFIN_RTC_BASE+RTCCON_OFFSET)
#define RTC_TICNT_REG			__REG(ELFIN_RTC_BASE+TICNT_OFFSET)
#define RTC_RTCALM_REG			__REG(ELFIN_RTC_BASE+RTCALM_OFFSET)
#define RTC_ALMSEC_REG			__REG(ELFIN_RTC_BASE+ALMSEC_OFFSET)
#define RTC_ALMMIN_REG			__REG(ELFIN_RTC_BASE+ALMMIN_OFFSET)
#define RTC_ALMHOUR_REG			__REG(ELFIN_RTC_BASE+ALMHOUR_OFFSET)
#define RTC_ALMDATE_REG			__REG(ELFIN_RTC_BASE+ALMDATE_OFFSET)
#define RTC_ALMMON_REG			__REG(ELFIN_RTC_BASE+ALMMON_OFFSET)
#define RTC_ALMYEAR_REG			__REG(ELFIN_RTC_BASE+ALMYEAR_OFFSET)
#define RTC_BCDSEC_REG			__REG(ELFIN_RTC_BASE+BCDSEC_OFFSET)
#define RTC_BCDMIN_REG			__REG(ELFIN_RTC_BASE+BCDMIN_OFFSET)
#define RTC_BCDHOUR_REG			__REG(ELFIN_RTC_BASE+BCDHOUR_OFFSET)
#define RTC_BCDDATE_REG			__REG(ELFIN_RTC_BASE+BCDDATE_OFFSET)
#define RTC_BCDDAY_REG			__REG(ELFIN_RTC_BASE+BCDDAY_OFFSET)
#define RTC_BCDMON_REG			__REG(ELFIN_RTC_BASE+BCDMON_OFFSET)
#define RTC_BCDYEAR_REG			__REG(ELFIN_RTC_BASE+BCDYEAR_OFFSET)
#define RTC_CUTICCNT_REG		__REG(ELFIN_RTC_BASE+CUTICCNT_OFFSET)
...
#define S5P_OTG_PHYTUNE 		(USBOTG_PHY_BASE + 0x020) /* R/W OTG PHY Tuning Register */
...
#ifndef __ASSEMBLY__
static inline S5PC1XX_MEMCTL * S5PC1XX_GetBase_MEMCTL(void)
{
	return (S5PC1XX_MEMCTL *)(APB_DMC_BASE);
}
static inline S5PC1XX_USB_HOST * S5PC1XX_GetBase_USB_HOST(void)
{
	return (S5PC1XX_USB_HOST *)ELFIN_USB_HOST_BASE;
}
static inline S5PC1XX_INTERRUPT * S5PC1XX_GetBase_INTERRUPT(void)
{
	return (S5PC1XX_INTERRUPT *)ELFIN_VIC0_BASE_ADDR;
}
static inline S5PC1XX_DMAS * S5PC1XX_GetBase_DMAS(void)
{
	return (S5PC1XX_DMAS *)ELFIN_DMA_BASE;
}
static inline S5PC1XX_CLOCK_POWER * S5PC1XX_GetBase_CLOCK_POWER(void)
{
	return (S5PC1XX_CLOCK_POWER *)ELFIN_CLOCK_POWER_BASE;
}
static inline S5PC1XX_LCD * S5PC1XX_GetBase_LCD(void)
{
	return (S5PC1XX_LCD *)ELFIN_LCD_BASE;
}
static inline S5PC1XX_UART * S5PC1XX_GetBase_UART(S5PC1XX_UARTS_NR nr)
{
	return (S5PC1XX_UART *)(ELFIN_UART_BASE + (nr*0x400));
}
static inline S5PC1XX_TIMERS * S5PC1XX_GetBase_TIMERS(void)
{
	return (S5PC1XX_TIMERS *)ELFIN_TIMER_BASE;
}
static inline S5PC1XX_WATCHDOG * S5PC1XX_GetBase_WATCHDOG(void)
{
	return (S5PC1XX_WATCHDOG *)ELFIN_WATCHDOG_BASE;
}
static inline S5PC1XX_I2C * S5PC1XX_GetBase_I2C(void)
{
	return (S5PC1XX_I2C *)ELFIN_I2C_BASE;
}
static inline S5PC1XX_I2S * S5PC1XX_GetBase_I2S(void)
{
	return (S5PC1XX_I2S *)ELFIN_I2S_BASE;
}
static inline S5PC1XX_GPIO * S5PC1XX_GetBase_GPIO(void)
{
	return (S5PC1XX_GPIO *)ELFIN_GPIO_BASE;
}
static inline S5PC1XX_RTC * S5PC1XX_GetBase_RTC(void)
{
	return (S5PC1XX_RTC *)ELFIN_RTC_BASE;
}
static inline S3C2410_ADC * S3C2410_GetBase_ADC(void)
{
	return (S3C2410_ADC *)ELFIN_ADC_BASE;
}
static inline S5PC1XX_SPI * S5PC1XX_GetBase_SPI(void)
{
	return (S5PC1XX_SPI *)ELFIN_SPI_BASE;
}
